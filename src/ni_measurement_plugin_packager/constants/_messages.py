...
class StatusMessages:
    ...
    INVALID_ROOT_DIRECTORY = "Invalid root directory for measurement plug-ins: '{dir}'. Provide the parent directory containing measurement plug-in directories."
    ...
    INVALID_PLUGIN = "Invalid measurement plug-in directory: missing required files (measurement.py, start.bat, or pyproject.toml)."
...
class CommandLinePrompts:
    ...
    PLUGIN_DIRECTORY_REQUIRED = "Specify '--input-path' or '--base-input-dir' with '--plugin-dir-name'."
