...
Provide the parent directory containing measurement plug-in folders."
    ...
    NO_MEAS_FILE = "Missing 'measurement.py' in directory: '{dir}'"
    ...
    FAILED_PUBLIC_DIR = (
        "Could not access PublicDocuments directory. Defaulting to UserDocuments for logging."
    )
    FAILED_USER_DIR = "Could not access UserDocuments directory. Using Temp directory for logging."
    BUILDING_MEAS = "Creating NI package for measurement '{name}'..."
    ...
    INVALID_MEAS_PLUGIN = "Invalid measurement plug-in folder: missing required files (measurement.py, start.bat, or pyproject.toml)."
...
class CommandLinePrompts:
    ...
    MEAS_DIR_REQUIRED = "Specify '--plugin-dir' or '--base-dir' with '--selected-meas-plugins'."
